...
\section{Description du projet}
    \input{sections/description_projet.tex}

\section{Prototypes de l'application}
    \input{sections/prototypes.tex}
...
\section{Backlogs}
    \subsection{Backlog de produit}
        \input{backlogs/backlog_produit.tex}

\newpage

    \subsection{Backlog de sprint \#1}
        \input{backlogs/sprint/sprint_1.tex}
    \subsection{Backlog de sprint \#2}
        \input{backlogs/sprint/sprint_2.tex}
    \subsection{Backlog de sprint \#3}
        \input{backlogs/sprint/sprint_3.tex}
    \subsection{Backlog de sprint \#4}
        \input{backlogs/sprint/sprint_4.tex}
